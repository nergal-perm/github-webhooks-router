## 1. Unit File
- [ ] 1.1 Create `deploy/` directory at the project root
- [ ] 1.2 Write `deploy/webhooks-router.service` with the following sections:
...
- [ ] 1.3 Verify the unit file passes `systemd-analyze verify deploy/webhooks-router.service` on an Ubuntu host (or note this as a manual check in the README)

## 2. Deployment Documentation
- [ ] 2.1 Create `deploy/README.md` with ordered install steps:
